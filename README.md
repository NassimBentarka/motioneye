...
I also added feature to encode in AV1 using VAAPI hardware acceleration which should save you 30% to 40% more in average video file size compared to HEVC.
